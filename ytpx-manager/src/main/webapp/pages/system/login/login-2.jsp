...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${skin}/login/2/login.css" />
	<script type="text/javascript" src="${skin}/login/2/login.js"></script>
</head>
<body>
	<div class="box">
	
		<div class="header">
			<img id="logo" src="${skin}/login/2/image/login-logo.png" width="460" height="40"/>
		</div>
					...
					<tbody>
						...
						<tr>
							...
							<td align="left" valign="bottom" style="height:60px;">
								<input id="login-btn" src="${skin}/login/2/image/btn_login.png" type="image" onclick="login();return false;"/>
							</td>
						</tr>
						<tr>
							<td colspan="2">
