...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
				...
				<tr>
					...
					<th data-options="field:'payStatus',width:50,
					 ...
					 <th data-options="field:'payType',width:60">缴费方式</th>
					  <th data-options="field:'discountType',width:60,
					   formatter:function(value,row,index) {
					 			if(value==1) return '学费折扣';
					 			if(value==0) return '学费减免';
					 			return '';
					 		}">优惠方案</th>				
					   <th data-options="field:'discount',width:60">优惠额度</th>								
  	...
  	<div id="toolbar" style="padding:2px;">
		...
		<w:auth url="/fileUpload/.*">
 		<a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true"  onclick="school.registe.exportTemplet();">报名模版</a>
 		</w:auth>
	</div>
  </body>
</html>
