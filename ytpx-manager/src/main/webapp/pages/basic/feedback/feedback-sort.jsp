  ...
  <body>
  	<div class="float-left" style="width:250px;height:100%;">
    	<table id="sort-datagrid" class="easyui-datagrid" data-options="
   			url:'${contextpath}/basic/feedback/query?rows=10000',
   			fit:true,
   			fitColumns:true,
			rownumbers:true,
			singleSelect:true,
    ...
    <div class="float-right" style="width:100px;margin-top:100px;">
    	<a class="easyui-linkbutton" onclick="basic.feedback.sortUp();">向上</a> 
    	<br /><br />
    	<a class="easyui-linkbutton" onclick="basic.feedback.sortDown();">向下</a> 
    </div>
    <div class="clear"></div>
  </body>
</html>
