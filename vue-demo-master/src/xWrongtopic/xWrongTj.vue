<template>
	...
	<div class="contain">
	  ...
	  <div class="contain-center" v-show="false">
	  	<span class="allPro">全部</span>
	  	<span class="wrongPro">错题统计</span>
	  </div>
...
//              this.selectValue = data.data.data[0].id;
   ...
   //获取筛选目录对应的章节列表
    ...
    goDel: function(id){
      this.$router.go({name:'xWrongPrt',params:{
        chapterId: id
      }});
